...
restaurant1 = Restaurant(name="Sammy's Pizzeria", cuisine="Italian")
...
review1 = Reviews(name = "Gaurav Keswani", restaurant = restaurant1, review = '''This Sammy's pizza in Powai is doing great from handling crowd to good service all I faced is 1 problem that it's conjugated and no proper seats arrangements.
																					Pizza lovers can hangout here as you will find many other pizza stores next to Sammy's
...
review2 = Reviews(name = "Vishesh Shah", restaurant = restaurant1, review = '''Just like any other Sammys outlet. I had to go with my all time favourite panner and onion. This time I tried the zingy parcel and it was totally OK. The veg parcel was a treat with little panner cubes and cream flowing out though it, but the non veg parcel was too hard to chew and tasted like uncooked dough!!! Definately not something worthing going on for the second time!!! But the panner and onion pizza never fails to amaze me... Its cheesey , its tasty and its very low on the pocket!!!!
Do try on the veg. Parcel my fellow foodies!!!!''' )
session.add(review2)
session.commit()

review3 = Reviews(name = "Saurabh Rawool", restaurant = restaurant1, review = '''This is in the Hiranandani business park close to a plethora of offices. Though I am not a pizza lover, went one day for a farewell party. The shop is too small for any Sammys outlet and gives a instant feeling that it has been setup to cater deliveries for all the offices around.
The seats are usual with no ambience whatsoever. Just a glass house to do business. As far the pizza is concerned, I did not find it even to Sammys standard which in itself is falling. It was just dry to say the least.The person doing the billing screwed up the bill as well. There was 30pc discount and we asked for a 10 pc corporate discount which they happily agreed upon. When the bill came, it was just 10pc and the 30 percent discount vanished. We asked once , they admitted the mistake and informed once bill is done , its irreversible. We did not pursue. The service was okay-ish.
Overall i don't like Sammys pizza but still get some delivered when in groups. It was a mistake visiting the store it seems. And this store did not make things better. Being in such a prime location, they should know how to handle clients or just run a delivery outlet.
